...
<section id="contact" class="dark">
      <header class="title">
      <h1 class="ride_text">Clint<span style="color: #f4db31;">Massage</span></h1>
          ...
          <div class="col-md-8 animated" data-animate="fadeInLeft">
            <form action="index.php" method="POST">
              <div class="row">
                ...
                <div class="col-md-6">
                  <input type="text" class="form-control" name="citystart" placeholder="City Start">
                </div>
                <div class="col-md-6">
                  <input type="text" class="form-control" name="cityend" placeholder="City End">
                </div>
                ...
                <div class="col-md-12">
                  <textarea class="form-control" rows="3" name="text" placeholder="Tell Us Everything"></textarea>
                </div>
                <div class="col-md-12">
                  <button type="submit" class="btn btn-default submit" name="snd_msg">Send Message</button>
                </div>
              </div>
            </form>
          </div>
...
<section id="contact" class="dark">
      <header class="title">
      <h1 class="ride_text">Driver<span style="color: #f4db31;">Massage</span></h1>
        <!-- <p>send massage any driver or car bike and trsport</p> -->
        <p class="long_text"> when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as It is a long established fact that a reader will be distracted by the readable c</p>
      </header>
          ...
          <div class="col-md-8 animated" data-animate="fadeInLeft">
            <form action="index.php" method="POST">
              <div class="row">
                ...
                <div class="col-md-6">
                  <input type="text" class="form-control" name="vehicletype" placeholder="Vehicle type">
                </div>
                ...
                <div class="col-md-12">
                  <button type="submit" class="btn btn-default submit" name="snd">Send</button>
                </div>
              </div>
            </form>
          </div>
...
<?php
    ...
    if(isset($_POST['snd_msg'])){
      ...
      $text = mysqli_real_escape_string( $con, $_POST['text']);
                                // registration
      $insertquery = " INSERT INTO registration(name, email, citystart, cityend, mobilenumber, vehicle,text) VALUES ('$name', '$email', '$citystart','$cityend', '$mobile', '$vehicle', '$text')";
    ...
    <script>
        ...
        ?>
        <script>
            alert("No Inserted <?=addslashes(mysqli_error($con))?>");
        </script>
            <?php
    }
...
<?php
    ...
    if(isset($_POST['snd'])){
      ...
      $cityend1 = mysqli_real_escape_string( $cn, $_POST['vehicletype']);
      ...
      $text1 = mysqli_real_escape_string( $cn, $_POST['text']);
                                // registration
      $isertquery = " INSERT INTO driver_registration(name, email, cityname, vehicletype, mobilenumber, vehicle,text) VALUES ('$name1', '$email1', '$citystart1','$cityend1', '$mobile1', '$vehicle1', '$text1')";
